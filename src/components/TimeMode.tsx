...
export const TimeMode = ({
  ...
  return (
    <div>
      ...
      <input
        className="accent-[#22a39f] border-0 outline-none my-1 rounded-[5px] h-[18px] bg-[#222222] text-[#f3efe0] p-1 focus:border-2 focus:my-[2px]"
        type="range"
        name="game_time"
        min="0"
        max="6"
      ...
      />
      <h4 className="mb-4">{timeString}</h4>
